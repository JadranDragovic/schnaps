...
def tab1():
    ...
    def kliknut7():
        ...
        def dijeljenje_karata():
            ...
            print(p1inv, p2inv)
            #karte_prikaz
            p1karta_1 = tk.Button(novi_prozor,text=p1inv[0],font=("Arial bold", 18), command=lambda:p1karta_1.destroy()).pack(padx=10,pady=10)
            ...
            def promijeni_red():
                ...
                if ciji_red % 2 != 0:
                    ...
                    p2karta_1.pack(padx=125,pady=550)
                    p2karta_2.pack(padx=325,pady=550)
                    p2karta_3.pack(padx=525,pady=550)
                    p2karta_4.pack(padx=725,pady=550)
                    p2karta_5.pack(padx=925,pady=550)
                    ciji_red +=1
                else:
                    turn_tekst = tk.Label(novi_prozor,text=f"{igrač1ime} je na redu!",font=("Arial bold", 30),bg="green",fg="white").place(x=460,y=50,width=400,height=60)
                    p1karta_1.pack(padx=125,pady=550)
                    p1karta_2.pack(padx=325,pady=550)
                    p1karta_3.pack(padx=525,pady=550)
                    p1karta_4.pack(padx=725,pady=550)
                    p1karta_5.pack(padx=925,pady=550)
                    ciji_red +=1
